...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/fig2_appearance_magician_lite.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/fig3_joint_coordinate_system.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/fig4_dh_frame_assignment.jpg}
