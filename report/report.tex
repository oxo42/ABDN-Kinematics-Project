...
\begin{figure}[htbp]
    \centering
    \vspace{-0.15cm}
    \includegraphics[width=0.92\textwidth]{figures/appearance_magician_lite.jpg}
    \caption{Dobot Magician Lite. Taken from \cite{dobotManual}.}
    \vspace{-0.45cm}
\end{figure}
\vspace{-0.25cm}
...
The physical robot is a series of 4-bar linkages that form a closed kinematic
chain. To simplify this, we have chosen to model the robot as a series of
revolute joints, and have included a passive joint P that keeps the end effector
parallel to the ground.

\begin{figure}[htbp]
    \centering
   % \vspace{-0.1cm}
    \includegraphics[width=0.62\textwidth]{figures/dh_frame_assignment.jpg}
...
given below. Note that the final rotation into the end effector framm $\alpha_3$
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{figures/principal_dimensions.jpg}
    \caption{Principal dimensions of the Dobot Magician Lite. Taken from \cite{dobotManual}.}
\end{figure}
