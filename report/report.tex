...
The inverse kinematics problem was solved using a geometric approach \cite{mathworks2023}. First,
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=1.5, >=stealth]
        ...
        \pic [draw, "$\theta_1$", angle eccentricity=1.5, angle radius=1cm] {angle = J3--O--Y};
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=1.5, >=stealth]
        ...
        % Angles
        \pic [draw, "$\theta_2$", angle eccentricity=1.3, angle radius=1cm] {angle = Zp--J1--J2u};
        \pic [draw, "$\theta_2$", angle eccentricity=1.1, angle radius=3cm] {angle = Zp--J1--J2d};
