...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/fig7_successful_inverse_kinematics_solution.jpg}
    \caption{Successful inverse kinematics solution using the MATLAB-based UI.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/fig8_unreachable_target.jpg}
