 ...
 MA2 = [
  ...
  MA3 = [
   ...
   MAp = [
    ...
    Transmat = MA1*MA2*MA3*MAp*MA4  %[output:6e28d34f]

X_def = Transmat(1,4) %[output:72bf46cb]
Y_def = Transmat(2,4) %[output:87639ce7]
Z_def = Transmat(3,4) %[output:505cfa27]
...
%---
%[output:6e28d34f]
%   data: {"dataType":"symbolic","outputData":{"name":"Transmat","value":"\\begin{array}{l}\n\\left(\\begin{array}{cccc}\n\\sin \\left(\\theta_4 \\right)\\,\\sigma_1 +\\cos \\left(\\theta_4 \\right)\\,\\sigma_4  & \\cos \\left(\\theta_4 \\right)\\,\\sigma_1 -\\sin \\left(\\theta_4 \\right)\\,\\sigma_4  & \\frac{4967757600021511\\,\\sin \\left(\\theta_1 \\right)}{81129638414606681695789005144064}+\\cos \\left(\\theta_2 +\\theta_3 \\right)\\,\\sigma_{10} -\\sin \\left(\\theta_2 +\\theta_3 \\right)\\,\\sigma_9  & \\frac{3\\,\\cos \\left(\\theta_3 \\right)\\,\\sigma_{15} }{20}+\\frac{3\\,\\cos \\left(\\theta_1 \\right)\\,\\cos \\left(\\theta_2 \\right)}{20}-\\frac{3\\,\\sin \\left(\\theta_3 \\right)\\,\\sigma_{16} }{20}-\\frac{14903272800064533\\,\\sin \\left(\\theta_1 \\right)\\,\\sin \\left(\\theta_2 \\right)}{1622592768292133633915780102881280}\\\\\n\\sin \\left(\\theta_4 \\right)\\,\\sigma_2 +\\cos \\left(\\theta_4 \\right)\\,\\sigma_3  & \\cos \\left(\\theta_4 \\right)\\,\\sigma_2 -\\sin \\left(\\theta_4 \\right)\\,\\sigma_3  & -\\frac{4967757600021511\\,\\cos \\left(\\theta_1 \\right)}{81129638414606681695789005144064}-\\cos \\left(\\theta_2 +\\theta_3 \\right)\\,\\sigma_7 -\\sin \\left(\\theta_2 +\\theta_3 \\right)\\,\\sigma_8  & \\frac{3\\,\\cos \\left(\\theta_3 \\right)\\,\\sigma_{14} }{20}+\\frac{3\\,\\sin \\left(\\theta_3 \\right)\\,\\sigma_{13} }{20}+\\frac{14903272800064533\\,\\cos \\left(\\theta_1 \\right)\\,\\sin \\left(\\theta_2 \\right)}{1622592768292133633915780102881280}+\\frac{3\\,\\cos \\left(\\theta_2 \\right)\\,\\sin \\left(\\theta_1 \\right)}{20}\\\\\n\\sin \\left(\\theta_4 \\right)\\,\\sigma_5 +\\cos \\left(\\theta_4 \\right)\\,\\sigma_6  & \\cos \\left(\\theta_4 \\right)\\,\\sigma_5 -\\sin \\left(\\theta_4 \\right)\\,\\sigma_6  & \\frac{24678615572571482867467662723121}{6582018229284824168619876730229402019930943462534319453394436096}-\\sin \\left(\\theta_2 +\\theta_3 \\right)\\,\\sigma_{12} -\\cos \\left(\\theta_2 +\\theta_3 \\right)\\,\\sigma_{11}  & \\frac{3\\,\\sin \\left(\\theta_2 \\right)}{20}+\\frac{3\\,\\cos \\left(\\theta_2 \\right)\\,\\sin \\left(\\theta_3 \\right)}{20}+\\frac{3\\,\\cos \\left(\\theta_3 \\right)\\,\\sin \\left(\\theta_2 \\right)}{20}\\\\\n0 & 0 & 0 & 1\n\\end{array}\\right)\\\\\n\\mathrm{}\\\\\n\\textrm{where}\\\\\n\\mathrm{}\\\\\n\\;\\;\\sigma_1 =\\sin \\left(\\theta_1 \\right)-\\frac{4967757600021511\\,\\cos \\left(\\theta_2 +\\theta_3 \\right)\\,\\sigma_{10} }{81129638414606681695789005144064}+\\frac{4967757600021511\\,\\sin \\left(\\theta_2 +\\theta_3 \\right)\\,\\sigma_9 }{81129638414606681695789005144064}\\\\\n\\mathrm{}\\\\\n\\;\\;\\sigma_2 =\\frac{4967757600021511\\,\\cos \\left(\\theta_2 +\\theta_3 \\right)\\,\\sigma_7 }{81129638414606681695789005144064}-\\cos \\left(\\theta_1 \\right)+\\frac{4967757600021511\\,\\sin \\left(\\theta_2 +\\theta_3 \\right)\\,\\sigma_8 }{81129638414606681695789005144064}\\\\\n\\mathrm{}\\\\\n\\;\\;\\sigma_3 =\\cos \\left(\\theta_2 +\\theta_3 \\right)\\,\\sigma_8 -\\sin \\left(\\theta_2 +\\theta_3 \\right)\\,\\sigma_7 \\\\\n\\mathrm{}\\\\\n\\;\\;\\sigma_4 =\\cos \\left(\\theta_2 +\\theta_3 \\right)\\,\\sigma_9 +\\sin \\left(\\theta_2 +\\theta_3 \\right)\\,\\sigma_{10} \\\\\n\\mathrm{}\\\\\n\\;\\;\\sigma_5 =\\frac{4967757600021511\\,\\cos \\left(\\theta_2 +\\theta_3 \\right)\\,\\sigma_{11} }{81129638414606681695789005144064}+\\frac{4967757600021511\\,\\sin \\left(\\theta_2 +\\theta_3 \\right)\\,\\sigma_{12} }{81129638414606681695789005144064}+\\frac{4967757600021511}{81129638414606681695789005144064}\\\\\n\\mathrm{}\\\\\n\\;\\;\\sigma_6 =\\cos \\left(\\theta_2 +\\theta_3 \\right)\\,\\sigma_{12} -\\sin \\left(\\theta_2 +\\theta_3 \\right)\\,\\sigma_{11} \\\\\n\\mathrm{}\\\\\n\\;\\;\\sigma_7 =\\cos \\left(\\theta_3 \\right)\\,\\sigma_{13} -\\sin \\left(\\theta_3 \\right)\\,\\sigma_{14} \\\\\n\\mathrm{}\\\\\n\\;\\;\\sigma_8 =\\cos \\left(\\theta_3 \\right)\\,\\sigma_{14} +\\sin \\left(\\theta_3 \\right)\\,\\sigma_{13} \\\\\n\\mathrm{}\\\\\n\\;\\;\\sigma_9 =\\cos \\left(\\theta_3 \\right)\\,\\sigma_{15} -\\sin \\left(\\theta_3 \\right)\\,\\sigma_{16} \\\\\n\\mathrm{}\\\\\n\\;\\;\\sigma_{10} =\\cos \\left(\\theta_3 \\right)\\,\\sigma_{16} +\\sin \\left(\\theta_3 \\right)\\,\\sigma_{15} \\\\\n\\mathrm{}\\\\\n\\;\\;\\sigma_{11} =\\cos \\left(\\theta_2 \\right)\\,\\cos \\left(\\theta_3 \\right)-\\sin \\left(\\theta_2 \\right)\\,\\sin \\left(\\theta_3 \\right)\\\\\n\\mathrm{}\\\\\n\\;\\;\\sigma_{12} =\\cos \\left(\\theta_2 \\right)\\,\\sin \\left(\\theta_3 \\right)+\\cos \\left(\\theta_3 \\right)\\,\\sin \\left(\\theta_2 \\right)\\\\\n\\mathrm{}\\\\\n\\;\\;\\sigma_{13} =\\frac{4967757600021511\\,\\cos \\left(\\theta_1 \\right)\\,\\cos \\left(\\theta_2 \\right)}{81129638414606681695789005144064}-\\sin \\left(\\theta_1 \\right)\\,\\sin \\left(\\theta_2 \\right)\\\\\n\\mathrm{}\\\\\n\\;\\;\\sigma_{14} =\\frac{4967757600021511\\,\\cos \\left(\\theta_1 \\right)\\,\\sin \\left(\\theta_2 \\right)}{81129638414606681695789005144064}+\\cos \\left(\\theta_2 \\right)\\,\\sin \\left(\\theta_1 \\right)\\\\\n\\mathrm{}\\\\\n\\;\\;\\sigma_{15} =\\cos \\left(\\theta_1 \\right)\\,\\cos \\left(\\theta_2 \\right)-\\frac{4967757600021511\\,\\sin \\left(\\theta_1 \\right)\\,\\sin \\left(\\theta_2 \\right)}{81129638414606681695789005144064}\\\\\n\\mathrm{}\\\\\n\\;\\;\\sigma_{16} =\\cos \\left(\\theta_1 \\right)\\,\\sin \\left(\\theta_2 \\right)+\\frac{4967757600021511\\,\\cos \\left(\\theta_2 \\right)\\,\\sin \\left(\\theta_1 \\right)}{81129638414606681695789005144064}\n\\end{array}"}}
%---
%[output:72bf46cb]
...
%---
%[output:5b215b87]
%   data: {"dataType":"textualVariable","outputData":{"name":"thet_3up","value":"-28.0169"}}
%---
%[output:8f3b7593]
